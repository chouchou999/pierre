...
# وظيفة إجبارية لتثبيت المكتبة من GitHub برمجياً
...
# تنفيذ التثبيت قبل تشغيل السيرفر
install_pyquotex()
...
# الآن نستدعيها بعد التأكد من تثبيتها
